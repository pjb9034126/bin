class PlatformsController < ApplicationController
  ...
  def create
	...
	user_id = @platform.user_id
	  newspaper_id = @platform.newspaper.id
	  @overlap = Platform.where(user_id: user_id, newspaper_id: newspaper_id).size
    respond_to do |format|
      if @platform.save
        format.html { redirect_to root_path, notice: '이미 구독했습니다.'}
      else
  ...
  private
    ...
    def platform_params
      params.require(:platform).permit(:user_id, :newspaper_id)
    end
end
