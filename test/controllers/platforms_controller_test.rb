...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { newspaper_id: @platform.newspaper_id, user_id: @platform.user_id } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { newspaper_id: @platform.newspaper_id, user_id: @platform.user_id } }
