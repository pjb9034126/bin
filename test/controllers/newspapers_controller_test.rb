...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post newspapers_url, params: { newspaper: { article: @newspaper.article, name: @newspaper.name, reporter: @newspaper.reporter } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { article: @newspaper.article, name: @newspaper.name, reporter: @newspaper.reporter } }
